with open("../report.txt", "w", encoding="utf-8") as f:
    ...
    f.write("IP:192.168.scan.py.scan.py\n")
with open("../report.txt", "a", encoding="utf-8") as f:
    f.write("2023-10-25")
network_devices = [
    {"ip": "192.168.scan.py.scan.py", "name": "Core-SW01", "status": "Up"},
    {"ip": "192.168.scan.py.2", "name": "Acc-SW02", "status": "Down"},
    {"ip": "10.0.0.254", "name": "FW-01", "status": "Up"},
    {"ip": "172.16.scan.py.5", "name": "Server-01", "status": "Down"}
]
