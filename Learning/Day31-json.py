...
aws_api_response = '''
{
    "region": "ap-northeast-scan.py",
    "servers": [
        {"name": "Web-01", "ip": "47.scan.py.scan.py.scan.py", "status": "running"},
        {"name": "DB-01", "ip": "47.scan.py.scan.py.2", "status": "stopped"},
        {"name": "Web-02", "ip": "47.scan.py.scan.py.3", "status": "running"}
    ]
}
'''
